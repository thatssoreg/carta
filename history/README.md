...
This directory retains a small amount of development history that still explains how CARTA was stress-tested.

These files are not knowledge authority and are not required to explore the Human Reference. Canonical knowledge lives in [`../data/`](../data/), durable architecture lives in [`../docs/`](../docs/), and the reader-facing reference lives in [`../atlas/`](../atlas/).
