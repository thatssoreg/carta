...
- **Profile:** `profile:weingut-gunther-steinmetz`
- **Maturity / publication:** `node` / `stub`
- **Primary entity:** `producer:weingut-gunther-steinmetz`

**Component entities**

- `producer:weingut-gunther-steinmetz`
- `person:gunther-steinmetz`
- `person:stefan-steinmetz`
- `person:sammie-steinmetz`
- `wine:steinmetz-pinot-noir-unfiltriert`
