...
- **Profile:** `profile:maison-pierre-overnoy`
- **Maturity / publication:** `node` / `stub`
- **Primary entity:** `producer:maison-pierre-overnoy`
...
- Build this Jura producer world from first-party and specialist evidence before baseline promotion
