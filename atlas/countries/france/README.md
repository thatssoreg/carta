...
- [Crozes-Hermitage AOP](appellations/crozes-hermitage.md) — appellation; baseline reference
- [Côte-Rôtie AOP](appellations/cote-rotie.md) — appellation; baseline reference
...
| `claim:vins-de-vienne-founding-17` | `reference / 2026-08-31` | `supported` | `high` | `source:syndicat-condrieu-vins-de-vienne` |
