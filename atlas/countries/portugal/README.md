...
- [Azores](regions/azores.md) — region; navigation node
...
- **Profile:** `profile:portugal`
- **Maturity / publication:** `node` / `stub`
- **Primary entity:** `place:portugal`
...
- Build a baseline national orientation covering represented mainland and island geographies
